...
Install express. `npm i express`. Check your files.
  - _Remember:_ If you have an older npm version below 5.0.0, you need to type `npm install express --save` instead! Refer back to your [notes](../instructor_notes/2.%20INTRO_TO_EXPRESS.md) if you need to be reminded of the differences between version 4 and 5  
...
To keep you sharp on coding challenges and algorithms, every so often for the rest of the cohort you'll also have to complete myGA modules as part of your homework. Not only are these required, but it's also in your best interest to go through these modules to prepare yourself for the following morning exercises as we'll be reviewing whatever you learn in these modules the day after. It's also in your best interest to just learn this stuff, of course!

**Tonight's required modules:**
...
## Hungry for more (express)?

<details><summary>Click to see the hungry for more options!</summary><p>
...
1. If you haven't already, finish the labs from today 

1. Work on the SUPER BONUS X-Files lab in the student labs folder
